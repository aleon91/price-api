...
import com.customer.priceapi.services.impl.PriceSrvImpl;
...
@SpringBootTest
public class PriceSrvTest {

    @InjectMocks
    private PriceSrvImpl priceSrv;
    @Mock
    ...
    public void findPriceByProductIdAndBrandIdAndDate1(){
        ...
        PriceEnt value = PriceEnt.builder()
            ...
            .productId(35455L)
            .build();
        Mockito.when(priceRep.findTopByProductIdAndBrandIdAndDateOrderByPriorityDesc(productId,brandId,date))
                .thenReturn(value);
        PriceEnt price = priceSrv.findPrice(productId,brandId,date);
